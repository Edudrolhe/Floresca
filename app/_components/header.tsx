import { MenuIcon, TruckIcon, HeartIcon, ShoppingCartIcon } from 'lucide-react'
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <Button variant="ghost" size="icon" className="relative shrink-0">
            ...
            <span className="absolute -right-1 -top-1 flex size-4 items-center justify-center rounded-full bg-purple-700 text-[10px] text-white">
              0
            </span>
          </Button>
